...
export default function CameraScreen() {
  ...
  const handleAcceptPhoto = () => {
    if (photo) {
      // Navegar de vuelta con la foto como parámetro usando el router de expo
      router.push({
        pathname: 'visita-activa',
        params: {
          photoUri: photo.uri,
  ...
  // Eliminamos handleRetakePhoto ya que es redundante con handleRetake
  ...
  // Vista si no se tienen los permisos
  if (!permission.granted) {
    return (
      <View style={[styles.container, styles.centerContent]}>
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={[styles.button, styles.acceptButton]} onPress={handleAcceptPhoto}>
